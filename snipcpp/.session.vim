...
silent only
silent tabonly
cd ~/.vim/plugged/vim-snippets/snipcpp
...
set winwidth=1
argglobal
if bufexists("genCppSnip.sh") | buffer genCppSnip.sh | else | edit genCppSnip.sh | endif
balt findmore.sh
let s:cpo_save=&cpo
set cpo&vim
